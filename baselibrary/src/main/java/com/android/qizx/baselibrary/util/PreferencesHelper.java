...
public class PreferencesHelper {
    ...
    public Integer getDownloadId(){
        return getInt(ISDOWNLOAD,ISDOWNLOAD,0);
    }
     ...
     */
     public void saveInviteCode(String inviteCode){
        saveString(INVITECODE,INVITECODE,inviteCode);
     }
...
//		LogOut.e("saveString:", commit+",key:"+key);
    ...
    public void saveHeadImage(String url){mPref.edit().putString(HEAD_IMAGE,url).apply();}
    public String getHeadImage(){
        return mPref.getString(HEAD_IMAGE,"");
    }
